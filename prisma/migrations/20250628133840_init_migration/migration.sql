...
CREATE TABLE "User" (
    ...
    "image" TEXT,
    CONSTRAINT "User_id_fkey" FOREIGN KEY ("id") REFERENCES "Carrinho" ("carrinhoid") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Carrinho_carrinhoid_key" ON "Carrinho"("carrinhoid");
