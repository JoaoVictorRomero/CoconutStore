...
export function Pqescolher(){
    ...
    return(  
        ...
        <div className="max-w-[1280px] h-[492px] bg-[linear-gradient(14deg,_#F0FDF4,_#FFFBEB)]">
        ...
        {/* Bloco do Titulo e Subtítulo */}
            <div className=" w-[600px] m-auto pt-15 pb-15">
                ...
                <p className="text-center text-[#4B5563] p-3">Compromisso com a qualidade e satisfação do cliente</p>
            </div>
            ...
            {/* Bloco do 100% Natural*/}
                <div className="w-[384px]">
                    ...
                    <div className="bg-white rounded-full w-[50px] h-[50px] m-auto shadow-lg/30">
                         <img className = "m-auto p-3"src="/imagem_componente_pqescolher1.png" alt="imagem de uma folha" />
                    </div>
                   
                    <h3 className="text-center font-semibold p-4"> 100% Natural </h3>
            ...
            {/* Bloco da Qualidade Garantida*/}
                <div className="w-[384px]">
                    ...
                    <h3 className="text-center font-semibold p-4"> Qualidade Garantida </h3>
            ...
            {/* Bloco da Entrega Rápida*/}
                <div className="w-[384px]">
                    ...
                    <h3 className="text-center font-semibold p-4"> Entrega Rápida </h3>
